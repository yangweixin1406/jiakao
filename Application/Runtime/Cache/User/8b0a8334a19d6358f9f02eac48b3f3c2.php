...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/email",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/email";
var g_isapp=0;
var c1c = 0;
...
<form method="post" id="form1" action="/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/email" onsubmit="return check();">
          <table style="width:100%; margin-left:auto; margin-right:auto;" cellpadding="1" class="tableinfo2">
				  <tr>
					 <td class="td1">邮箱：</td>
					 <td class="td2"><input type="text"  value="<?php echo ($info["email"]); ?>" class="txt" name="email" placeholder="请输入邮箱"  style="width:80%;"/><input  type="button"  value="获取验证码" name="bt"  class="bt1"/></td>
				  </tr>
				  <tr>
					 <td class="td1">邮箱：</td>
					 <td class="td2"><input type="text"  value="<?php echo ($info["email"]); ?>" class="txt" name="email" placeholder="请输入邮箱验证码" /></td>
				  </tr>
				  <tr>
