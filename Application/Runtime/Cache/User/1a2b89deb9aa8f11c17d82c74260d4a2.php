...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/touxiang",
	app:"/phpsite/hc/kaoti/kaoti20170406/index.php",
	url:"/phpsite/hc/kaoti/kaoti20170406/index.php/User/User",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/touxiang";
var g_isapp=0;
var c1c = 0;
...
<script src="/phpsite/hc/kaoti/kaoti20170406/Public/home/caidan.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/phpsite/hc/kaoti/kaoti20170406/Public/uploadhtml5e/cropper/css/cropper.min.css">
    <script type="text/javascript" src="/phpsite/hc/kaoti/kaoti20170406/Public/uploadhtml5e/cropper/jquery-1.9.2.min.js"></script>
    <script type="text/javascript" src="/phpsite/hc/kaoti/kaoti20170406/Public/uploadhtml5e/cropper/js/cropper.min.js"></script>
	<script type="text/javascript" src="/phpsite/hc/kaoti/kaoti20170406/Public/uploadhtml5e/cropper/hcfilejietu-0.1.js"></script>
	 <link rel="stylesheet" type="text/css" href="/phpsite/hc/kaoti/kaoti20170406/Public/uploadhtml5e/cropper/hcfilejietu.css">
</head>
<body>
<div class="mybody">
...
<div class="mymain" >
<div class="padding10">
<form method="post" id="form1" action="/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/touxiang" onsubmit="return mycheck('form1');">
          <div class="g-form">
			   <div class="field">
				    <div class="field-title" style="text-align:center;">选择头像</div>
					<div class="field-content">
					 <input type="hidden" id="photo" value="<?php echo ($info["photo"]); ?>" class="txt" name="photo"/>
						<div id="changeAvatar" style="margin-top:20px; margin-bottom:20px; position:relative;">
							<img src="/phpsite/hc/kaoti/kaoti20170406/Public/uploadhtml5e/cropper/images/default.jpg" style="width: 200px;margin-top: 10px;margin: 0 auto;display:block; border-radius:100px; box-shadow:0px 0px 10px 1px #666666;" id="touxiang">
							<div style="position:absolute; left:0px; width:100%; text-align:center;top:80px;">
							 <input type="button" id="mybt" value="上传" style="background-color:#0099CC; height:40px; width:40px;line-height:40px;border-radius:20px;color:#FFFFFF; border:0px;"/>
							</div>
						</div>
					</div>
			  </div>
	...
	//http://www.htmleaf.com/jQuery/Image-Effects/201504211716.html
	        ...
	        hcfilejietu().init({url:"/phpsite/hc/kaoti/kaoti20170406/Public/uploadhtml5e/include/php/ajax.php",imgsite:"",bt_id:"mybt",input_id:"photo",img_id:"touxiang",type:1,conf:{width:400,height:400}});
	</script>
			  ...
			  <div class="g-btnav">
			   <input type="hidden" id="id" value="<?php echo ($info["id"]); ?>" class="txt" name="id"/>
			    <input  type="button"  value="提交" name="act" class="bt1" onclick="mycheck('form1');" style="width:99%"/>
			  </div>
		  </div>
