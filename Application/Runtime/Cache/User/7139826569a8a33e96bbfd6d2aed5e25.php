...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/pwd",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/User/User/pwd";
var g_isapp=0;
var c1c = 0;
...
<div class="mymain" >
<div class="padding10">
<form method="post" id="form1" action="<?php echo U('User/pwd');?>" onsubmit="return check();">
          <table style="width:100%; margin-left:auto; margin-right:auto;" cellpadding="1" class="tableinfo2">
				  <tr>
					 <td class="td1">旧密码：</td>
					 <td class="td2"><input type="text"  value="" class="txt" name="userpwdold" placeholder="请输入旧密码" /></td>
				  </tr>
				  <tr>
					 <td class="td1">新密码：</td>
					 <td class="td2"><input type="text"  value="" class="txt" name="userpwd" placeholder="请输入新密码" /></td>
				  </tr>
				  <tr>
					 <td class="td1">确认新密码：</td>
					 <td class="td2"><input type="text"  value="" class="txt" name="userpwd1" placeholder="请输入确认新密码" data-bijiao="userpwd" data-bijiao-tishi="二次密码不一致" /></td>
				  </tr>
				  <tr>
