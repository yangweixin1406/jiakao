...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/User/Address/lists",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/User/Address/lists";
var g_isapp=0;
var c1c = 0;
...
<div class="mymain" >
<div class="padding10">
<div class="g-title"><span class="l">列表</span><span  class="r"><a href="<?php echo U('Address/info');?>" class="g-bt1">去添加地址</a></span></div>
			 ...
			 <?php if(empty($list)): ?><div class="divnull"><span class="yuan">&nbsp;</span><p><a href="<?php echo U('Address/info');?>">去添加地址</a></p></div><?php endif; ?>
