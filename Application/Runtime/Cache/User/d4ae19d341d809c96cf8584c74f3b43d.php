...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/User/Uaddress/lists",
	app:"/phpsite/hc/kaoti/kaoti20170406/index.php",
	url:"/phpsite/hc/kaoti/kaoti20170406/index.php/User/Uaddress",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/User/Uaddress/lists";
var g_isapp=0;
var c1c = 0;
...
<div class="mymain" >
<div class="padding10">
<div class="g-title"><span class="l">列表</span><span  class="r"><a href="<?php echo U('info');?>" class="g-bt1">去添加地址</a></span></div>
                <table class="tablelist" cellspacing="0">
				<tbody>
				       <?php if(is_array($list)): foreach($list as $key=>$value): ?><tr onclick="window.location='<?php echo U('info',array('id'=>$value[id]));?>'" style="cursor:pointer;">
							<td class="td1"><div style="font-size:15px;"><?php echo ($value["province"]); ?>-<?php echo ($value["city"]); ?>-<?php echo ($value["country"]); ?></div><p class="g-color"><?php echo ($value["address"]); ?></p></td>
							<td class="td2" style="width:30px"><?php if(($value["status"] == 1)): ?><span class="g-hs">默认</span><?php endif; ?></td>
							<td class="tdop" style="width:auto"><a href="<?php echo U('del',array('id'=>$value[id]));?>" class="btdel g-bta">删除</a></td>
						</tr><?php endforeach; endif; ?>
				</tbody>
             </table>
			 <?php if(empty($list)): ?><div class="divnull"><span class="yuan">&nbsp;</span><p><a href="<?php echo U('info');?>">去添加地址</a></p></div><?php endif; ?>
