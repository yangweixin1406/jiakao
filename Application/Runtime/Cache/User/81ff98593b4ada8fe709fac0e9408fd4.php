...
<div class="menuline">
 ...
 <ul class="ulmenu_orders">
    <li><a href="<?php echo U('orders/lists',array('date'=>'now'));?>"><i class="fa fa-file-text-o"></i><span>今日订单</span></a></li>
	<li><a href="<?php echo U('orders/lists',array('date'=>'zuori'));?>"><i class="fa fa-file-text-o"></i><span>昨日订单</span></a></li>
	<li><a href="<?php echo U('orders/lists',array('status'=>'notpay'));?>"><i class="fa fa-file-text-o"></i><span>未付款</span></a></li>
	<li><a href="<?php echo U('orders/lists',array('status'=>'okpay'));?>"><i class="fa fa-file-text-o"></i><span>已付款</span></a></li>
	<li><a href="<?php echo U('orders/lists',array('status'=>'1'));?>"><i class="fa fa-file-text-o"></i><span>已完成</span></a></li>
 </ul>
 <div class="clear"></div>
</div>
<div class="menuline">
