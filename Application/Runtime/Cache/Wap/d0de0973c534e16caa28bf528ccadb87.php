...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/djlist",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/djlist";
var g_isapp=0;
var c1c = 0;
...
<body>
<div class="mybody">
<div class="curnav" id="curnav" style="position:absolute; top:0px; left:0px; z-index:1000"><div><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/index/"><?php echo ($web["title"]); ?></a></center><a class="amenu">≡</a></div></div>
<div id="subnav" class="subnav"  style="position:absolute; top:45px; left:0px; z-index:1000;">
         <div  class="w800 rel">
			 <div class="inner">
			   <div class="con"><span class="tit"><i  class="hs"><?php if($web[key]!=""){ echo '"'.$web[key].'"';}?></i>商家列表</span><span class="r"><?php echo ($web["p"]); ?>/<?php echo ($web["totalPages"]); ?>页</span></div>
			 </div>
		 </div>
</div>
 ...
 <div class="w800 inner">
  <div id="plist" class="djlist">
   <?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>">
    ...
    <?php if(empty($list)): ?><div class="divnull">找不到任何商家</div><?php endif; ?>
