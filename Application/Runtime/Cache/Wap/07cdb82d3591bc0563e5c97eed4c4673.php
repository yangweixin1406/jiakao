...
<link rel="stylesheet" type="text/css" href="/phpsite/hc/kaoti/kaoti20170406/Public/<?php echo MODULE_NAME ?>/shop.css?1">
<script src="/phpsite/hc/kaoti/kaoti20170406/Public/<?php echo MODULE_NAME ?>/func.js"></script>
<!--[if IE 6]>
<style>
...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/index",
	app:"/phpsite/hc/kaoti/kaoti20170406/index.php",
	url:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/index";
var g_isapp=0;
var c1c = 0;
...
<body>
<div class="mybody">
<div class="curnav" id="curnav" style="position:fixed; top:0px; left:0px; z-index:1001"><div><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><form action="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/search/"  method="get" onsubmit="return checkform(this);"><input type="text" name="key"  placeholder="请输入店铺名/商品名"/><input type="submit" value="查询" name="btsubmit"/></form></center><a class="amenu">≡</a></div></div>
...
<!--			焦点图结束-->
         ...
         <div  class="w800" style="margin-top:10px;">
            <div id="indexclass" class="iclass">
			  <div class="rel">
			   <div class="item" data-id="<?php echo ($row["id"]); ?>"><a class="aurl" style="color:#009900" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists/djid/<?php echo ($dianjia["id"]); ?>/"><div class="img"></div><span class="title">全部</span></a></div>
			   <?php if(is_array($pclass)): foreach($pclass as $key=>$row): ?><div class="item" title="<?php echo ($row["title"]); ?>" data-id="<?php echo ($row["id"]); ?>">
			   <a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists/djid/<?php echo ($dianjia["id"]); ?>/djclassid/<?php echo ($row["id"]); ?>"><div class="img"></div><span class="title"><?php echo ($row["title"]); ?></span></a>
			   </div><?php endforeach; endif; ?>
			 </div>
		   </div>
        </div>
  ...
  <div class="tabpanelist">
	<div class="tabpane" style="display:block">
       <!--开始-->
			<div class="pkuang" style="margin-top:0px; border-top:0px;">
					 <div class="inner">
						  <div class="shoptitle"><span class="tit">商铺列表</span><span class="more"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/djlist/">&gt;&gt;更多</a></span></div>
						  <div class="plist" style="margin-top:0px;">
						   <?php if(is_array($shop)): foreach($shop as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>" >
							 <a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/home/djid/<?php echo ($row["id"]); ?>/" class="aurl">
    ...
    <div class="tabpane">
       <!--开始-->
			<div class="pkuang" style="margin-top:0px; border-top:0px;">
					 <div class="inner">
						  <div class="shoptitle"><span class="tit">推荐商品</span><span class="more"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/pclass/djid/<?php echo ($dianjia["id"]); ?>/">&gt;&gt;更多</a></span></div>
						  <div class="plist" style="margin-top:0px;">
						   <?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>" >
							 <a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/pdetail/djid/<?php echo ($row["dianjiaid"]); ?>/id/<?php echo ($row["id"]); ?>" class="aurl">
							 <div  class="rel" style="border:0px;">
								<div class="left"> 
								<div class="photo"><img data-src="/phpsite/hc/kaoti/kaoti20170406/<?php echo ($row["photo"]); ?>" src="/phpsite/hc/kaoti/kaoti20170406/Public/images/logo.gif"/></div>
								</div>
			...
			<div class="pkuang" style="margin-top:0px; border-top:0px;">
					 <div class="inner">
						  <div class="shoptitle"><span class="tit">热卖商品</span><span class="more"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists/djid/<?php echo ($dianjia["id"]); ?>/">&gt;&gt;更多</a></span></div>
						  <div class="plist" style="margin-top:0px;">
						   <?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>" >
							 <a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/pdetail/djid/<?php echo ($row["dianjiaid"]); ?>/id/<?php echo ($row["id"]); ?>" class="aurl">
							 <div  class="rel" style="border:0px;">
...
<div id="pro_tmp" style="display:none;">
		<div class="item" data-id="{id}" >
		 <a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/pdetail/djid/{dianjiaid}/id/{id}" class="aurl">
			<div  class="rel" style="border:0px;">
			<div class="left"> 
