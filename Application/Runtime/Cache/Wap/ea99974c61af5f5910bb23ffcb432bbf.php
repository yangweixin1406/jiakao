...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/User/index",
	app:"/phpsite/hc/kaoti/kaoti20170406/index.php",
	url:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/User",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/User/index";
var g_isapp=0;
var c1c = 0;
...
<div class="menuline">
 ...
 <ul class="ulmenu_orders">
    <li><a href="<?php echo U('user/orders');?>"><i class="fa fa-file-text-o"></i><span>今日订单</span></a></li>
	<li><a href="<?php echo U('user/my');?>"><i class="fa fa-file-text-o"></i><span>昨日订单</span></a></li>
	<li><a href="<?php echo U('user/favo');?>"><i class="fa fa-file-text-o"></i><span>未付款</span></a></li>
	<li><a href="<?php echo U('user/address');?>"><i class="fa fa-file-text-o"></i><span>已付款</span></a></li>
	<li><a href="<?php echo U('user/pwd');?>"><i class="fa fa-file-text-o"></i><span>已完成</span></a></li>
 </ul>
 <div class="clear"></div>
</div>
<div class="menuline">
 ...
 <ul class="ulmenu">
	...
	<li><a href="<?php echo U('user/favo');?>"><i class="fa fa-star-o"></i><span>我的收藏</span></a></li>
	<li><a href="<?php echo U('user/address');?>"><i class="fa fa-map"></i><span>收货地址</span></a></li>
	...
	<li><a href="<?php echo U('user/zuji');?>"><i class="fa fa-object-group"></i><span>我的足迹</span></a></li>
