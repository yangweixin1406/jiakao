...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/pdetail",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/pdetail";
var g_isapp=0;
var c1c = 0;
...
<div class="pdetail-bottom">
   ...
   <div class="b-bt2"><span class="in"><a href='/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/home/djid/<?php echo ($info["dianjiaid"]); ?>'>店铺</a></span></div>
...
$(".hc-tab").each(function(){
  ...
  <div id="protj" class="protj">
         <div  class="rel">
			 ...
			 <?php if(is_array($protj)): foreach($protj as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>"><div class="inner"><div class="photo"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/pdetail/djid/<?php echo ($row["dianjiaid"]); ?>/id/<?php echo ($row["id"]); ?>" class="aurl"><img data-src="<?php echo ($row["photo"]); ?>" src="<?php echo ($dianjia["nullimg"]); ?>"></a></div></div></div><?php endforeach; endif; ?>
			 </div>
		 </div>
  </div>
