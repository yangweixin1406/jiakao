...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/home",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/home";
var g_isapp=0;
var c1c = 0;
...
<div class="curnav pcurnav" id="curnav" style="position:absolute; top:0px; left:0px; z-index:1001"><div class="w800 rel"><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><form action="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists/djid/<?php echo ($dianjia["id"]); ?>"  method="get" onsubmit="return checkform(this);"><input type="text" name="key"  placeholder="请输入商品名"/><input type="submit" value="查询" name="btsubmit"/></form></center><a class="amenu">≡</a></div></div>
...
<div class="pclass"  id="pclass">
         <div  class="w800 rel">
			 <div class="inner">
			   <div class="item" data-id="<?php echo ($row["id"]); ?>"><a class="aurl" style="color:#009900" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists/djid/<?php echo ($dianjia["id"]); ?>/">全部</a></div>
			   <?php if(is_array($pclass)): foreach($pclass as $key=>$row): ?><div class="item<?php if($web['djclassid']==$row[id]){echo ' focus';}?>" title="<?php echo ($web['djclassid']); ?>" data-id="<?php echo ($row["id"]); ?>"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists/djid/<?php echo ($dianjia["id"]); ?>/djclassid/<?php echo ($row["id"]); ?>"><?php echo ($row["title"]); ?></a></div><?php endforeach; endif; ?>
			 </div>
		 </div>
</div>
<script>
