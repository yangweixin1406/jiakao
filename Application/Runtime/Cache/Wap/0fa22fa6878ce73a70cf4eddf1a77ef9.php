...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/plists";
var g_isapp=0;
var c1c = 0;
...
<body>
<div class="mybody">
<div class="curnav" id="curnav" style="position:absolute; top:0px; left:0px; z-index:1000"><div><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Wap/Shop/home/djid/<?php echo ($dianjia["id"]); ?>"><?php echo ($web["title"]); ?></a></center><a class="amenu">≡</a></div></div>
<div id="pclass" class="pclass"  style="position:absolute; top:45px; left:0px; z-index:1000;">
         <div  class="w800 rel">
			 <div class="inner">
 ...
 <div class="w800 inner">
  <div id="plist" class="plist">
   <?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>">
    ...
    <?php if(empty($list)): ?><div class="divnull">找不到商品</div><?php endif; ?>
