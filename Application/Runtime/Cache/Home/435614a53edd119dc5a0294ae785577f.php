...
var conf={
	...
	action:"/index.php/Home/User/reg",
	app:"/index.php",
...
window.g_actionurl="/index.php/Home/User/reg";
var g_isapp=0;
var c1c = 0;
...
<form method="post" id="form1" action="/index.php/Home/User/reg" onsubmit="return check();">
          <table style="width:100%; margin-left:auto; margin-right:auto;" cellpadding="1" class="tableinfo2">
				  ...
				  <tr>
					 <td class="td1">密码：</td>
					 <td class="td2"><input type="text"   value="" class="txt" name="userpwd" placeholder="请输入密码"/></td>
				  </tr>
				  <tr>
					 <td class="td1">二次密码：</td>
					 <td class="td2"><input type="text"   value=""  class="txt" name="userpwd1" data-bijiao="userpwd" data-bijiao-tishi="二次密码不一致" placeholder="请输入二次密码"/></td>
				  </tr>
<?php if($reg_setting["codetype"] == 'smscode'): ?><tr>
					 <td class="td1">验证码：</td>
...
<?php elseif($reg_setting["codetype"] == 'emailcode'): ?>
				  <tr>
					 <td class="td1">验证码：</td>
...
<?php elseif($reg_setting["codetype"] == 'code'): ?>
				  <tr>
					 <td class="td1">验证码：</td>
