...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlist",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlist";
var g_isapp=0;
var c1c = 0;
...
<body>
<div class="mybody">
<div class="curnav" id="curnav" style="position:absolute; top:0px; left:0px; z-index:1000"><div><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/index/"><?php echo ($web["title"]); ?></a></center><a class="amenu">≡</a></div></div>
<div id="pclass" class="pclass"  style="position:absolute; top:45px; left:0px; z-index:1000;">
         <div  class="w800 rel">
			 <div class="inner">
			   <div class="item" data-id="<?php echo ($row["id"]); ?>"><a class="aurl" style="color:#009900" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlist/">全部</a></div>
			   <?php if(is_array($pclass)): foreach($pclass as $key=>$row): ?><div class="item<?php if($web['classid']==$row[id]){echo ' focus';}?>" title="<?php echo ($web['classid']); ?>" data-id="<?php echo ($row["id"]); ?>"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlist/classid/<?php echo ($row["id"]); ?>"><?php echo ($row["title"]); ?></a></div><?php endforeach; endif; ?>
			 </div>
		 </div>
</div>
