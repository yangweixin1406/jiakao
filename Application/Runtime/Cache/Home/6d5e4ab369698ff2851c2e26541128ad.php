...
<body>
<div class="mybody">
<div class="curnav" id="curnav" style="position:absolute; top:0px; left:0px; z-index:1001"><div><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/index/djid/<?php echo ($dianjia["id"]); ?>"><?php echo ($web["title"]); ?></a></center><a class="amenu">≡</a></div></div>
...
.slick-prev{ left:5px; z-index:2000;}
.slick-next{ right:5px;}
.slick-dotted.slick-slider{ margin-bottom:5px;}
.slick-dots li{ margin:0px;}
.huandeng-photolist{ height:200px; overflow:hidden; width:100%;}
.huandeng-slider{ height:100%;}
.huandeng-slider .item{ height:200px;  width:100%; text-align:center; background-color:#f5f5f5;}
.huandeng-slider .item img{ height:100%; margin-left:auto; margin-right:auto;}
</style>
...
<div class="pkuang">
		 <div class="w800 inner">
			  <div class="shoptitle"><span class="tit">推荐商品</span><span class="more"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/plists/djid/<?php echo ($dianjia["id"]); ?>/">&gt;&gt;更多</a></span></div>
