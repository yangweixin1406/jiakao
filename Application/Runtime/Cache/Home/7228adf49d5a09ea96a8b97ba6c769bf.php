...
var conf={
	...
	action:"/index.php/Home/Exam1/class2",
	app:"/index.php",
...
window.g_actionurl="/index.php/Home/Exam1/class2";
var g_isapp=0;
var c1c = 0;
...
<?php if(is_array($classlist)): foreach($classlist as $key=>$row): ?><li class="ul_menu_li">
   <div class="subtitle1"><a href1="/index.php/Home/Exam1/list" classno="<?php echo ($row["classno"]); ?>" class="li_a1"><?php echo ($row["title"]); ?></a></div>
   ...
   <?php if(is_array($row['class1'])): foreach($row['class1'] as $key1=>$row1): ?><li classno="<?php echo ($row1["classno"]); ?>" class="ul_menusub1_li">
          ...
          <ul class="ul_menusub2" style="display:none;">
           <?php if(is_array($conf1["items"])): foreach($conf1["items"] as $key=>$row2): if($row2["value"] == 'moni'): ?><li><a href="/index.php/Home/Exam1/lists/table/<?php echo ($table); ?>/act/<?php echo ($row2["value"]); ?>/fatherid/<?php echo ($data["fatherid"]); ?>/classid/<?php echo ($row1["id"]); ?>/"><?php echo ($row2["name"]); ?></a></li>
             <?php else: ?>
            <li><a href="/index.php/Home/Exam1/lists/table/<?php echo ($table); ?>/act/<?php echo ($row2["value"]); ?>/fatherid/<?php echo ($data["fatherid"]); ?>/classid/<?php echo ($row1["id"]); ?>/tpl/lists_a"><?php echo ($row2["name"]); ?></a></li><?php endif; endforeach; endif; ?>
         </ul>
