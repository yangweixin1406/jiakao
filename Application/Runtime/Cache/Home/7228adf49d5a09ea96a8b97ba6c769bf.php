...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Exam1/class2",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Exam1/class2";
...
<style>
 .mymain{ width:1000px; margin-left:auto; margin-right:auto; margin-top:20px;}
 ...
 .ul_menu_class1 li .item{height:100px;background-color: #099;  width:80%; margin-left:auto; margin-right:auto;}
  .ul_menu_class1 li .item .rel{ height:100%; width:100%; position:relative;}
  .ul_menu_class1 li .a1{font-size:20px;text-align:center; line-height:21px; color:#FFFFFF;word-wrap:break-word; word-break:normal; word-break:break-all;}
  .ul_menu_class1 li .item table{ height:100%; width:100%;}
  .ul_menu_class1 li .item .title1{ font-size:16px; margin:0px; padding:0px;}
 ...
 @media screen and (max-width:1000px){
	...
	.ul_menu_class1 li .item{height:80px;width:98%;}
	.ul_menu_class1 li{ width:33%; float:left; padding-top:10px; padding-bottom:10px;}
 } 
...
<div class="curnav"><a  class="back" href="/phpsite/hc/kaoti/kaoti20170406/index.php"><em>d</em></a><center><?php echo ($webtitle); ?></center><a class="amenu">≡</a></div>

<div id="exam_menu">
<ul class="ul_menu">
<?php if(is_array($classlist)): foreach($classlist as $key=>$row): ?><li class="ul_menu_li">
   <div class="subtitle1"><a href1="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Exam1/list" classno="<?php echo ($row["classno"]); ?>" class="li_a1"><?php echo ($row["title"]); ?></a></div>
   <ul class="ul_menusub1" style="display:<?php if($key != 0): ?>none<?php endif; ?>;">
   <?php if(is_array($row['class1'])): foreach($row['class1'] as $key1=>$row1): ?><li classno="<?php echo ($row1["classno"]); ?>" class="ul_menusub1_li">
          <div class="subtitle2"><?php echo ($row1["title"]); ?></div>
          <ul class="ul_menusub2" style="display:none;">
           <?php if(is_array($conf1["items"])): foreach($conf1["items"] as $key=>$row2): if($row2["value"] == 'moni'): ?><li><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Exam1/lists/table/<?php echo ($table); ?>/act/<?php echo ($row2["value"]); ?>/fatherid/<?php echo ($data["fatherid"]); ?>/classid/<?php echo ($row1["id"]); ?>/"><?php echo ($row2["name"]); ?></a></li>
             <?php else: ?>
            <li><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Exam1/lists/table/<?php echo ($table); ?>/act/<?php echo ($row2["value"]); ?>/fatherid/<?php echo ($data["fatherid"]); ?>/classid/<?php echo ($row1["id"]); ?>/tpl/lists_a"><?php echo ($row2["name"]); ?></a></li><?php endif; endforeach; endif; ?>
         </ul>
