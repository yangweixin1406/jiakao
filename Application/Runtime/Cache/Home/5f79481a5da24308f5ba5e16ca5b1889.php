...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/classlist",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/classlist";
var g_isapp=0;
var c1c = 0;
...
<div class="curnav" id="curnav" style="position:absolute; top:0px; left:0px; z-index:1000"><div><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/index/djid/<?php echo ($dianjia["id"]); ?>"><?php echo ($web["title"]); ?></a></center><a class="amenu">≡</a></div></div>

<div id="subnav" class="subnav"  style="position:absolute; top:45px; left:0px; z-index:1000;">
         <div  class="w800 rel">
			 <div class="inner">
			   <div class="con"><span class="tit">服务类别</span></div>
			 </div>
		 </div>
</div>
 ...
 <div class="w800 inner">
  <div id="classlist" class="classlist">
   <?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>">
	 <a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlist/classid/<?php echo ($row["id"]); ?>" class="aurl">
	 <div  class="rel">
	    <div class="left"> 
