...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Favorites/lists",
	app:"/phpsite/hc/kaoti/kaoti20170406/index.php",
	url:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Favorites",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Favorites/lists";
...
<div class="mymain">
		...
		<?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="exam_item" id="exam_<?php echo ($key+1); ?>" data-value="<?php echo ($row["value"]); ?>" data-index="<?php echo ($key+1); ?>" data-title="<?php echo ($row["name"]); ?>" data-id="<?php echo ($row["id"]); ?>"  data-type="<?php echo ($row["type"]); ?>" data-idno="<?php echo ($row["idno"]); ?>"  data-kemu="<?php echo ($row["kemu"]); ?>">
		   <div class="inner">
		    <h1 class="title"><?php echo ($row["index"]); ?>.<?php echo ($row["name"]); ?><span class="show_daan" style="display:none">(<?php echo ($row["value"]); ?>)</span></h1>
				<ul class="ul1">
				...
				<?php }?>
				<div class="clear"></div>
			   <div class="bt_qd_line"><input class="bt_remove_favorites" type="button" value="移除收藏" title="移除收藏"/><?php if($row["type"] == 2): ?><input type="button" name="bt_ok" class="bt_ok" value="<?php echo ($conf_lang[btcaption]); ?>" /><?php endif; ?></div>
			
		    <div class="op"><span class="my_daan">你的答案：<i>未做答</i></span><span class="data_daan"></span></div>
			</div>
		 </div><?php endforeach; endif; ?>
		<div class="divnull_a" style="display:<?php if(count($list)<1){echo '';}else{echo 'none';} ?>">没有收藏记录</div>
