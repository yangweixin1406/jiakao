...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Goumaiex/index",
	app:"/phpsite/hc/kaoti/kaoti20170406/index.php",
	url:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Goumaiex",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Goumaiex/index";
...
$(function(){
	...
	$(".curnav .amenu,.curnav_a .amenu_a").click(function(){
	    ...
	    str+="<li class='limyinfo'><a href='"+conf.app+"/"+conf.module+"/user/info"+"'>我的资料</a></li>";
		str+="<li class='limypwd'><a href='"+conf.app+"/"+conf.module+"/user/pwd"+"'>修改密码</a></li>";
...
<div class="padding10">
<div class="titleinfo1">明细</div>
<form method="post" id="form1" action="/phpsite/hc/kaoti/kaoti20170406/index.php?m=home&c=goumaiex&a=index&classid=41">
          <table style="width:100%; margin-left:auto; margin-right:auto;" cellpadding="1" class="tableinfo2">
				  ...
				  <tr>
					 ...
					 <td class="td2"><?php echo ($info["price"]); ?>块</td>
				  </tr>
				  <tr>
					<td colspan="2" align="center" class="tdop">
					<input  type="submit"  value="提交" name="act" class="bt1"/>
					 <input type="hidden" name="classid" value="<?php echo ($info["id"]); ?>" /></td>
				  </tr>
          </table>
</form>
</div>
