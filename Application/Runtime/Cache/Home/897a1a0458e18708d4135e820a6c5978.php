...
<html xmlns="http://www.w3.org/1999/xhtml" class="chezi" style=" background:none;">
<head>
...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Orders/lists",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Orders/lists";
...
<body>
<div class="mybody" style="display:none1;">
...
<div class="padding10">
<div class="titleinfo1" style="display:none"></div>
               <table class="tablelist" cellspacing="0">
				<thead>
					<tr>
						<th class='td1' style="text-align:center; width:40px;">日期</th>
						<th class='td2' style=" width:55px;">&nbsp;</th>
						<th class='td3'>信息</th>
					</tr>
				</thead>
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr onclick="javascript:window.location='/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Orders/info/id/<?php echo ($value["id"]); ?>';">
							<td class="td1"><span class="addtime"><span class="year"><?php echo date("Y",$value[time]);?></span><span class="monthday"><?php echo date("m-d",$value[time]);?></span></span></td>
							<td class="td2"><div class="logo"><img src="/phpsite/hc/kaoti/kaoti20170406/<?php echo ($value["logo"]); ?>"/></div></td>
							<td class="td3">
							   <div class="rel"><div class="total"><?php if($value[type]==1){ echo "-";} else{echo "+";} echo ($value["total"]); ?></div><div class="lable<?php if($value[lable]==1){ echo " lise";}?>"><?php echo ($value["lablecaption"]); ?></div></div>
