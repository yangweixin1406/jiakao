...
window.g_actionurl="/index.php/Home/User/my";
var g_isapp=0;
var c1c = 0;
...
<form method="post" id="form1" action="/index.php/Home/User/my" onsubmit="return check();">
          <table style="width:100%; margin-left:auto; margin-right:auto;" cellpadding="1" class="tableinfo2">
				  ...
				  <tr>
					 ...
					 <td class="td2">
							 ...
							 <td><iframe src="/Public/uploadiframe/one.php?folder=user&inputid=photo&bttext=1&qzimg=/&filename=tx<?php echo ($info["id"]); ?>&textalign=left&classname=bt_lable1&btfontsize=" scrolling="no" style="height:35px;width:70px;border:0px;" frameborder="0px" allowtransparency="true"></iframe></td>
							 </tr></table>
					 </td>
				  </tr>
				  <tr>
