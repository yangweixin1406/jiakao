...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/search",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/search";
var g_isapp=0;
var c1c = 0;
...
<body>
<div class="mybody">
<div class="curnav" id="curnav" style="position:absolute; top:0px; left:0px; z-index:1001"><div><a  class="back" href="<?php echo ($backurl); ?>"><em>d</em></a><center><form action="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/search/"  method="get" onsubmit="return checkform();"><input type="text" name="key"  placeholder="请输入店铺名/商品名"/><input type="submit" value="查询" name="btsubmit"/></form></center><a class="amenu">≡</a></div></div>
...
<div class="mymain" style="position:absolute; left:0px; top:45px; width:100%;">
<div class="w800">
<!--焦点图开孡-->
			<div class="pkuang">
					 <div class="inner">
						  <div class="shoptitle"><span class="tit">找到<?php echo (count($shop)); ?>家商铺</span><span class="more"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/djlist/key/<?php echo ($web["key"]); ?>/">&gt;&gt;更多</a></span></div>
						  <div class="djlist" style="margin-top:0px;">
						   <?php if(is_array($shop)): foreach($shop as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>">
							...
							<?php if(empty($shop)): ?><div class="divnull">查找不到商铺</div><?php endif; ?>
						  </div>
						  <div class="clear"></div>
					</div>
			</div>
			<div class="pkuang">
					 <div class="inner">
						  <div class="shoptitle"><span class="tit">找到<?php echo (count($product)); ?>件商品</span><span class="more"><a class="aurl" href="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlist/key/<?php echo ($web["key"]); ?>/">&gt;&gt;更多</a></span></div>
						  <div class="plist" style="margin-top:0px;">
						   <?php if(is_array($product)): foreach($product as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>" >
							...
							<?php if(empty($product)): ?><div class="divnull">查找不到商品</div><?php endif; ?>
						  </div>
						  <div class="clear"></div>
					</div>
			</div>
