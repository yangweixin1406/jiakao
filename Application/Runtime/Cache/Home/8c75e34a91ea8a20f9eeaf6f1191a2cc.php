...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Orders/detail",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Orders/detail";
...
<style>
.tabledetail{ background-color:#999999;}
.tabledetail th{ background-color:#f5f5f5; text-align:left;}
.tabledetail td{ background-color:#fff;}
</style>
</head>
<body>
<div class="mybody">
...
<div class="orders_head">
      ...
      <h1 class="total">共<?php echo ($info["price"]); ?></h1>
</div>

          <table style="width:100%; margin-left:auto; margin-right:auto;" cellpadding="10" class="tabledetail" cellspacing="1">
				  <tr>
					 <th class="td1">商品名称</th>
					 <th class="td2">商品价格</th>
					 <th class="td3">购买数量</th>
				  </tr>
				  <?php if(is_array($list)): foreach($list as $key=>$row): ?><tr>
					  <td class="td1"><?php echo ($row["title"]); ?></td>
					  <td class="td2"><?php echo ($row["price"]); ?>元</td>
					  <td class="td3"><?php echo ($row["num"]); ?>件</td>
				  </tr><?php endforeach; endif; ?>
				  <tr>
					<td colspan="3" align="center" class="tdop">
