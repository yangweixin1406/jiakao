...
var conf={
	...
	action:"/index.php/Home/Goumaiex/lists",
	app:"/index.php",
	url:"/index.php/Home/Goumaiex",
...
window.g_actionurl="/index.php/Home/Goumaiex/lists";
var g_isapp=0;
var c1c = 0;
...
<div class="titleinfo1" style="display:none"></div>
               <table class="tablelist" cellspacing="0">
				<thead>
					<tr>
						<th class='td1'>商品标题</th>
						<th class='td2'>金额</th>
						<th class='td3'>购买日期</th>
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="td2"><?php echo ($value["total"]); ?></td>
							<td class="td3"><?php echo ($value["addtime"]); ?></td>
							<td class="tdop" style="width:auto"><a href="/index.php/Home/Goumaiex/info/id/<?php echo ($value["id"]); ?>">&gt;</a></td>
