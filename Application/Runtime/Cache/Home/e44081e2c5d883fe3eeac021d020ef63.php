...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlists",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Shop/productlists";
...
<style>
.pclass{ border-bottom:solid #CCCCCC 1px; height:50px; overflow:hidden; width:100%;}
.pclass .rel{ height:auto; overflow:hidden; height:55px; width:100%; padding-bottom:20px; overflow-x:auto;}
.pclass .rel .inner{ height:auto; overflow:hidden; height:50px;}
.pclass .rel .item{ width:auto; float:left; height:50px; line-height:50px; padding-left:10px; padding-right:10px;}
...
<div class="mymain" >
  <div id="pclass" class="pclass">
         <div  class="rel">
			 <div id="pclass_inner" class="inner">
			 <?php if(is_array($pclass)): foreach($pclass as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>"><?php echo ($row["title"]); ?></div><?php endforeach; endif; ?>
			 </div>
		 </div>
  </div>
  <div id="plist" class="plist">
   <?php if(is_array($list)): foreach($list as $key=>$row): ?><div class="item" data-id="<?php echo ($row["id"]); ?>">
	 ...
	 <div  class="rel">
	    <div class="left"> 
	    <div class="photo"><img src="/phpsite/hc/kaoti/kaoti20170406/<?php echo ($row["photo"]); ?>" onerror="this.src='/phpsite/hc/kaoti/kaoti20170406/Public/images/error.gif';this.onerror=null;"/></div>
		</div>
        <div class="right">  
		  	    <div class="title">荣耀8青春版 全网通 标配版 3GB+32GB <?php echo ($row["title"]); ?>流光金</div>
...
function myresize(){
  var wz=0;
  $("#pclass .item").each(function(){
     wz+=$(this).width();
  }); 
  $("#pclass_inner").css("width",wz+50+"px"); 
  var pitems=$("#plist .item");
  //var y=pitems.length%3;
