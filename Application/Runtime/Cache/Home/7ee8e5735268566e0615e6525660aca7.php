...
var conf={
	...
	action:"/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Goumaiex/info",
...
window.g_actionurl="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Goumaiex/info";
...
<body>
<div class="mybody">
<div class="curnav"><a  class="back" href="<?php echo ($laiyuan); ?>"><em>d</em></a><center><?php echo ($web["title"]); ?></center><a class="amenu">≡</a></div>
<div class="mymain" >
<div class="padding10">
<div class="titleinfo1"><h1>费用<?php echo ($info["total"]); ?>块</h1></div>
<form method="post" id="form1" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Home/Goumaiex/info" onsubmit="return check();">
