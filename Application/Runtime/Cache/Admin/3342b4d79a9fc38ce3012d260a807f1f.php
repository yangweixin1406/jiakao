...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		<div class="left"><div class="tt"><?php echo ($mytitle); ?>&nbsp;(<?php echo ($item["num"]); ?>/<?php echo ($item["rowcountz"]); ?>)</div><div class="bb"><a href="/index.php/Admin/Exam/info/table/<?php echo ($table); ?>">发布考题</a></div><span class="btchazhao">查找</span></div>
		<div class="right">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="tdop"><a href="/index.php/Admin/Exam/info/id/<?php echo ($value["id"]); ?>">编辑</a>|<a href="/index.php/Admin/Exam/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
