...
<div class="info1">
	   ...
	   <ul class="ul_info"><li class="li1">记录编号：</li><li class="li2"><?php echo ($info["logno"]); ?></li></ul>
	   <ul class="ul_info"><li class="li1">订单标题：</li><li class="li2"><?php echo ($info["title"]); ?></li></ul>
  ...
  <div class="info_bts">
    <div class="con">
	 ...
	 <input type="button" onclick="javascript:window.location='<?php echo ($laiyuan); ?>';"value="返回列表" class="bt" /><input id="id" type="hidden" name="id" value="<?php echo ($info["id"]); ?>"/>
