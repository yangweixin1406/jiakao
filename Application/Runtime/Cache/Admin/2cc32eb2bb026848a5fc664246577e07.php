...
<form id="form1" name="form1" method="post" action="<?php echo U('weixin_api');?>" onsubmit="return check();">
<div class="info1">


	   <div class="tab_page">
	   <fieldset><legend>微信公众号api配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="weixin_api_status" name="setting[weixin_api][status]" value="<?php echo ($setting[weixin_api][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">微信帐号：</li><li class="li2"><input type="text" name="setting[weixin_api][email]" value="<?php echo ($setting[weixin_api][email]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">微信appid：</li><li class="li2"><input type="text" name="setting[weixin_api][appid]" value="<?php echo ($setting[weixin_api][appid]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">微信appsecret：</li><li class="li2"><input type="text" name="setting[weixin_api][appsecret]" value="<?php echo ($setting[weixin_api][appsecret]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">微信key：</li><li class="li2"><input type="text" name="setting[weixin_api][key]" value="<?php echo ($setting[weixin_api][key]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">微信mchid：</li><li class="li2"><input type="text" name="setting[weixin_api][mchid]" value="<?php echo ($setting[weixin_api][email]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">cert.pem文件：</li><li class="li2">
		
		 <table><tr>
		 <td><input type="text" name="setting[weixin_api][cert_path]"  id="cert_path" value="<?php echo ($setting[weixin_api][cert_path]); ?>"  /></td>
		 <td><iframe src="/phpsite/hc/kaoti/kaoti20170406/Public/uploadiframe/one.php?folder=cert&inputid=cert_path&bttext=1&qzimg=../&filename=apiclient_cert&textalign=left&classname=bt_lable1&btfontsize=" scrolling="no" style="height:40px;width:300px;border:0px;" frameborder="0px" allowtransparency="true"></iframe></td>
		 </tr></table>
		 
		</li></ul>
		<ul class="ul_info"><li class="li1">key.pem文件：</li><li class="li2">
		 <table><tr>
		  <td><input type="text" name="setting[weixin_api][key_path]" id="key_path" value="<?php echo ($setting[weixin_api][key_path]); ?>"  /></td>
		 <td><iframe src="/phpsite/hc/kaoti/kaoti20170406/Public/uploadiframe/one.php?folder=cert&inputid=key_path&bttext=1&qzimg=../&filename=apiclient_key&textalign=left&classname=bt_lable1&btfontsize=" scrolling="no" style="height:40px;width:300px;border:0px;" frameborder="0px" allowtransparency="true"></iframe></td>
		 </tr></table>
