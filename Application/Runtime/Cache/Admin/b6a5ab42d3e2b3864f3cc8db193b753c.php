...
<div class="info1">
	   ...
	   <div class="tab_page">
	   <fieldset><legend>邮箱配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="email_status" name="setting[email][status]" value="<?php echo ($setting[email][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">邮箱服务器：</li><li class="li2"><input type="text" name="setting[email][smtpserver]" value="<?php echo ($setting[email][smtpserver]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">邮箱服务器端口：</li><li class="li2"><input type="text" name="setting[email][smtpserverport]" value="<?php echo ($setting[email][smtpserverport]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">邮箱帐号：</li><li class="li2"><input type="text" name="setting[email][smtpuser]" value="<?php echo ($setting[email][smtpuser]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">邮箱帐号密码：</li><li class="li2"><input type="password" name="setting[email][smtppass]" value="<?php echo ($setting[email][smtppass]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">smtpSecure：</li><li class="li2"><input type="text" name="setting[email][smtpsecure]" value="<?php echo ($setting[email][smtpsecure]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">找回密码标题：</li><li class="li2"><textarea type="text" name="setting[email][title1]" class="txt1" ><?php echo ($setting[email][title1]); ?></textarea><div>标题例子：你的新密码：{pwd}</div></li></ul>
		<ul class="ul_info"><li class="li1">找回密码内容：</li><li class="li2"><textarea type="text" name="setting[email][content1]" class="txt1" ><?php echo ($setting[email][content1]); ?></textarea><div>例子：你的新密码：{pwd}</div></li></ul>
		<ul class="ul_info"><li class="li1">注册验证码标题：</li><li class="li2"><textarea type="text" name="setting[email][title2]" class="txt1" ><?php echo ($setting[email][title2]); ?></textarea><div>标题例子：你的注册验证码是：{code}</div></li></ul>
		<ul class="ul_info"><li class="li1">注册验证码内容：</li><li class="li2"><textarea type="text" name="setting[email][content2]" class="txt1" ><?php echo ($setting[email][content2]); ?></textarea><div>例子：你的注册验证码是：{code}</div></li></ul>
	   </fieldset>
