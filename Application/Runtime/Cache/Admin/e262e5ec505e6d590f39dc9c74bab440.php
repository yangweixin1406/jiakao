...
<form id="form1" name="form1" method="post" action="<?php echo U('email');?>" onsubmit="return check();">
<div class="info1">


	   <div class="tab_page">
	   <fieldset><legend>客服配置1</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="kefu_status0" name="setting[kefu][0][status]" value="<?php echo ($setting[kefu][0][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">客服标题：</li><li class="li2"><input type="text" name="setting[kefu][0][title]" value="<?php echo ($setting[kefu][0][title]); ?>"  class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">客服号码：</li><li class="li2"><input type="text" name="setting[kefu][0][idno]" value="<?php echo ($setting[kefu][0][idno]); ?>"    class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">客服分组：</li><li class="li2"><input type="text" name="setting[kefu][0][type]" value="<?php echo ($setting[kefu][0][type]); ?>"    class="txt1"/><span>qq或wangwang</span></li></ul>

	   </fieldset>
	   <fieldset><legend>客服配置2</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="kefu_status1" name="setting[kefu][1][status]" value="<?php echo ($setting[kefu][1][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">客服标题：</li><li class="li2"><input type="text" name="setting[kefu][1][title]" value="<?php echo ($setting[kefu][1][title]); ?>"  class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">客服号码：</li><li class="li2"><input type="text" name="setting[kefu][1][idno]" value="<?php echo ($setting[kefu][1][idno]); ?>"    class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">客服分组：</li><li class="li2"><input type="text" name="setting[kefu][1][type]" value="<?php echo ($setting[kefu][1][type]); ?>"    class="txt1"/><span>qq或wangwang</span></li></ul>

	   </fieldset>
	   <fieldset><legend>客服配置3</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="kefu_status2" name="setting[kefu][2][status]" value="<?php echo ($setting[kefu][2][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">客服标题：</li><li class="li2"><input type="text" name="setting[kefu][2][title]" value="<?php echo ($setting[kefu][2][title]); ?>"  class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">客服号码：</li><li class="li2"><input type="text" name="setting[kefu][2][idno]" value="<?php echo ($setting[kefu][2][idno]); ?>"    class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">客服分组：</li><li class="li2"><input type="text" name="setting[kefu][2][type]" value="<?php echo ($setting[kefu][2][type]); ?>"    class="txt1"/><span>qq或wangwang</span></li></ul>
...
onoff("kefu_status0",100);
onoff("kefu_status1",100);
onoff("kefu_status2",100);
</script>
<script>
