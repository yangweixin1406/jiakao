...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		<div class="left"><div class="tt"><?php echo ($mytitle); ?>&nbsp;(<?php echo ($item["num"]); ?>/<?php echo ($item["rowcountz"]); ?>)</div><div class="bb"><a href="<?php echo U('content/info');?>">发布文章</a></div><span class="btchazhao">查找</span></div>
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Content/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
					 <span class="t">文章分类<em>：</em></span>
					 <span class="f">
				...
				<div class="row">
				   <span class="t">文章名称<em>：</em></span><span class="f"><input type="text" name="title" id="title" value="<?php echo $title?>" class="txt1s"/></span>
				</div>
				<div class="row">
				   <span class="t">文章ID<em>：</em></span><span class="f"><input type="text" name="id" id="id" value="<?php echo $id?>"  class="txt1s"/></span>
				</div>
				<div class="row">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				<thead>
					<tr>
						...
						<th class='td1'><?php echo ($lang); ?>标题</th>
						<th class='td2'><?php echo ($lang); ?>分类</th>
						<th class='td3'><?php echo ($lang); ?>状态</th>
						<th class='td4'>录入日期</th>
						<th class='tdop'>操作</th>
					</tr>
				</thead>
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="td2"><?php echo ($value["class_caption"]); ?></td>
							<td class="td3"><?php echo ($value["state_caption"]); ?></td>
                            <td class="td4"><?php echo ($value["addtime"]); ?></td>
							<td class="tdop"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Content/info/id/<?php echo ($value["id"]); ?>">编辑</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Content/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
