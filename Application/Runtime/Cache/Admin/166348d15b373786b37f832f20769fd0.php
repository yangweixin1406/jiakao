...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		<div class="left"><div class="tt"><?php echo ($mytitle); ?>&nbsp;(<?php echo ($item["num"]); ?>/<?php echo ($item["rowcountz"]); ?>)</div><div class="bb"><a href11="<?php echo U('info');?>" style="color:#CCCCCC">添加记录</a></div><span class="btchazhao">查找</span></div>
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Paylog/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
				...
				<div class="row">
				   <span class="t">订单编号<em>：</em></span><span class="f"><input type="text" name="logno" id="logno" value="<?php echo ($item["logno"]); ?>" class="txt1s"/></span>
				</div>
				<div class="row">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="td1"><?php echo ($value["title"]); ?></td>
							...
							<td class="tdop"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Paylog/info/id/<?php echo ($value["id"]); ?>">编辑</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Paylog/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
