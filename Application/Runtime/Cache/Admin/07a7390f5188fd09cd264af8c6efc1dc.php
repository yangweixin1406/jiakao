...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		...
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/User/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="tdop"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/User/info/id/<?php echo ($value["id"]); ?>">编辑</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/User/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
