...
<ul class="ul_info"><li class="li1">价格：</li><li class="li2"><input type="text"  name="price" id="price"   class="txt1" value="<?php echo ($info["price"]); ?>"/></li></ul>
...
<script>
ClassOption().init({url:"<?php echo U('class/classoption');?>","id":"fatherno","fatherno":"0001","classno":"<?php echo ($info["fatherno"]); ?>"});
