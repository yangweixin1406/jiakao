...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		...
		<div class="right">
			<form id="form1" name="form1" method="get" action="/index.php/Admin/Usergroup/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
               ...
               <table class="tablelist" cellspacing="0">
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="tdop"><a href="/index.php/Admin/Usergroup/list/id/<?php echo ($value["id"]); ?>" style="display:none;">查看|</a><a href="/index.php/Admin/Usergroup/download/id/<?php echo ($value["id"]); ?>" target="_blank">下载</a>|<a href="/index.php/Admin/Usergroup/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
