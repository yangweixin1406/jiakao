...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		<div class="left"><div class="tt"><?php echo ($mytitle); ?>&nbsp;(<?php echo ($item["num"]); ?>/<?php echo ($item["rowcountz"]); ?>)</div><div class="bb"><a href="<?php echo U('info');?>">批量生成</a></div><span class="btchazhao">查找</span></div>
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Usergroup/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
					 <span class="t">卡前缀<em>：</em></span>
					 <span class="f">
					 <input type="text" title="卡前缀" value="" name="cardqianzhui" class="txt1s" />
					</span>
				</div>
				<div class="row">
				   <span class="t">默认密码<em>：</em></span><span class="f"><input type="text" title="默认密码" value="" name="cardpwd" class="txt1s"/></span>
				</div>
				<div class="row">
				   <span class="t">天数<em>：</em></span><span class="f"><input type="text" title="天数" value="" name="day"  class="txt1s"/></span>
				</div>
				<div class="row">
				   <span class="t">有效次数<em>：</em></span><span class="f"><input type="text" title="有效次数" value="" name="youxiaocishu"  class="txt1s"/></span>
				</div>
				<div class="row">
					<span class="t ts">&nbsp;</span><span class="f"><input type="hidden" name="table" id="table" value="<?php echo $table?>" /><input type="submit" name="search" id="button" value="提交" class="btsearch" /></span>
				</div>
			</div>
			</form>
		</div>
               ...
               <table class="tablelist" cellspacing="0">
				<thead>
					<tr>
						...
						<th class="td1">卡前缀</th>
						<th class="td2">默认密码</th>
                        <th class="td3">天数</th>
                        <th class="td4">有效次数</th>
                        <th class="td5">生成数量</th>
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="td1"><?php echo ($value["cardqianzhui"]); ?></td>
							<td class="td2"><?php echo ($value["cardpwd"]); ?></td>
                            <td class="td3"><?php echo ($value["day"]); ?></td>
                            <td class="td4"><?php echo ($value["youxiaocishu"]); ?></td>
                            <td class="td5"><?php echo ($value["num"]); ?></td>
                            <td class="td6"><?php echo ($value["addtime"]); ?></td>
							<td class="tdop"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Usergroup/list/id/<?php echo ($value["id"]); ?>" style="display:none;">查看|</a><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Usergroup/download/id/<?php echo ($value["id"]); ?>" target="_blank">下载</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Usergroup/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
