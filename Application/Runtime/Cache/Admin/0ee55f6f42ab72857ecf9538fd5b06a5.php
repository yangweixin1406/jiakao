...
<form id="form1" name="form1" method="post" action="<?php echo U('save');?>" onsubmit="return check();">
	   ...
	   <div class="tab_page">
	    ...
	    <ul class="ul_info"><li class="li1">网站名称：</li><li class="li2"><input type="text" name="name" id="name" value="<?php echo ($info["name"]); ?>" class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">联系人：</li><li class="li2"><input type="text" name="contact" id="contact" value="<?php echo ($info["contact"]); ?>" class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">移动电话：</li><li class="li2"><input type="text" name="phone" id="phone" value="<?php echo ($info["phone"]); ?>"    class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">联系地址：</li><li class="li2"><input type="text" name="address" id="address" value="<?php echo ($info["address"]); ?>"  class="txt1"/></li></ul>
        <ul class="ul_info"><li class="li1">电子邮箱：</li><li class="li2"><input type="text" name="email" id="email" value="<?php echo ($info["email"]); ?>"  class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">简要：</li><li class="li2"><input type="text" name="des" id="des" value="<?php echo ($info["des"]); ?>"  class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">版权所有：</li><li class="li2">
