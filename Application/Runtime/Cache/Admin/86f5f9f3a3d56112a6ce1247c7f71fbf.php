...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		<div class="left"><div class="tt"><?php echo ($mytitle); ?>&nbsp;(<?php echo ($item["num"]); ?>/<?php echo ($item["rowcountz"]); ?>)</div><div class="bb"><a href="<?php echo U('product/info');?>">发布产品</a></div><span class="btchazhao">查找</span></div>
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Product/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
					 <span class="t">产品分类<em>：</em></span>
					 <span class="f">
				...
				<div class="row">
				   <span class="t">产品名称<em>：</em></span><span class="f"><input type="text" name="title" id="title" value="" class="txt1s"/></span>
				</div>
				<div class="row">
				   <span class="t">产品ID<em>：</em></span><span class="f"><input type="text" name="id" id="id" value=""  class="txt1s"/></span>
				</div>
				<div class="row">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				<thead>
					<tr>
						...
						<th class='td2'>产品价格</th>
						<th class='td3'>产品分类</th>
                        <th class='td4'>上架状态</th>
						<th class='td5'>帐号</th>
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="td2"><?php echo ($value["prices"]); ?></td>
							<td class="td3"><?php echo ($value["class_caption"]); ?></td>
                            <td class="td4"><?php echo ($value["state_caption"]); ?></td>
                            <td class="td5"><?php echo ($value["username"]); if(trim($value["shopname"])!=""){echo "<br/><a href='/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Product/lists/dianjiaid/".$value[dianjiaid]."'>".$value['shopname']."</a>";}?></td>
							<td class="td6"><?php echo ($value["addtime"]); ?></td>
							<td class="tdop"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Product/info/id/<?php echo ($value["id"]); ?>">编辑</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Product/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
