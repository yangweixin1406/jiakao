...
<form id="form1" name="form1" method="post" action="<?php echo U('kaoti');?>" onsubmit="return check();">
<div class="info1">


	   <div class="tab_page">
	   <fieldset><legend>考题系统配置</legend>
	    <ul class="ul_info"><li class="li1">系统模式：</li><li class="li2">
				    <label><input type="radio" class="moshi" name="setting[kaoti][biaomoshi]" value="1" title="普通验证码"/>单表模式</label>
		            <label><input type="radio" class="moshi" name="setting[kaoti][biaomoshi]" value="2" title="不需要"/>多表模式</label>
		</li></ul>
...
$(".moshi").each(function(){
   if($(this).val()=="<?php echo ($setting[kaoti][biaomoshi]); ?>"){
