...
<div class="info1">
	   ...
	   <div class="tab_page">
	    ...
	    <ul class="ul_info"><li class="li1">卡前缀：</li><li class="li2"><input type="text" name="cardqianzhui" id="cardqianzhui" value="<?php echo ($info["cardqianzhui"]); ?>" class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">默认密码：</li><li class="li2"><input type="text" name="cardpwd"   id="cardpwd" value="<?php echo ($info["cardpwd"]); ?>" class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">天数：</li><li class="li2"><input type="text" name="day" id="day"  class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">有效次数：</li><li class="li2"><input type="text" name="youxiaocishu" id="youxiaocishu" value="<?php echo ($info["youxiaocishu"]); ?>"   class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">生成会员数量：</li><li class="li2"><input type="password" name="num" id="num" value="<?php echo ($info["num"]); ?>"  class="txt1" /></li></ul>
  ...
  <div class="info_bts">
    <div class="con">
	 ...
	 <input type="button" onclick="javascript:window.location='<?php echo ($laiyuan); ?>';"value="返回" class="bt" /><input type="submit" name="btsend" class="btsend" value="提交" /><input id="id" type="hidden" name="id" value="<?php echo ($info["id"]); ?>"/><input id="act" type="hidden" name="act" value="update"/> <input type="reset" value="重置" onclick="clearinput()" />
...
function check(){
  var cardqianzhui=$("#cardqianzhui");
  var cardpwd=$("#cardpwd");
  var day=$("#day");
   var youxiaocishu=$("#youxiaocishu");
   var num=$("#num");
  if(cardqianzhui.val()==""){
	 alert("请输入卡前缀");
	 cardqianzhui.focus();
