...
<form id="form1" name="form1" method="post" action="<?php echo U('info');?>">
<div class="info1">
...
<?php if(is_array($kemulist)): foreach($kemulist as $key=>$row): ?><option value="<?php echo ($row["value"]); ?>"><?php echo ($row["name"]); ?></option><?php endforeach; endif; ?></select></li></ul>
	   ...
	   <ul class="ul_info" style=" overflow:hidden;"><li class="li1">图片：</li><li class="li2" style=" overflow:hidden;">
	       <input type="hidden" name="photo" id="photo"  value="<?php echo ($info["photo"]); ?>"/><iframe src="/phpsite/hc/kaoti/kaoti20170406/Public/upload_20150420/upload/php/img_iframe.php?panel_id=my_show&input_only_id=photo&input_more_id=ImageList&maxnum=10" scrolling="no" frameborder="0" height="80" width="80" style="margin:5px;"></iframe>
	   </li>
      </ul>
	     ...
	     <ul class="ul_info" id="ul_qturl" style="display:none;">
		     ...
		     <li class="li2">
						<a href="/phpsite/hc/kaoti/kaoti20170406/index.php?m=Home" target="_blank">/phpsite/hc/kaoti/kaoti20170406/index.php?m=Home</a>
						<br/>
						<a href="/phpsite/hc/kaoti/kaoti20170406/index.php?m=Home" target="_blank">/phpsite/hc/kaoti/kaoti20170406/index.php?m=Home</a>
			 </li>
		 </ul>
