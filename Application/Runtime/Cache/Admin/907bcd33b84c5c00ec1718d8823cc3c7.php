...
<form id="form1" name="form1" method="post" action="<?php echo U('point');?>" onsubmit="return check();">
<div class="info1">


	   <div class="tab_page">
	   <fieldset><legend>积分兑换现钱配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="pointtomoney_status" name="setting[pointtomoney][status]" value="<?php echo ($setting[pointtomoney][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">积分：</li><li class="li2"><input type="text" name="setting[pointtomoney][point]" value="<?php echo ($setting[pointtomoney][point]); ?>" class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">得现金：</li><li class="li2"><input type="text" name="setting[pointtomoney][money]" value="<?php echo ($setting[pointtomoney][money]); ?>"  class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">限制最小积分：</li><li class="li2"><input type="text" name="setting[pointtomoney][min]" value="<?php echo ($setting[pointtomoney][min]); ?>"  class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">限制最大积分：</li><li class="li2"><input type="text" name="setting[pointtomoney][max]" value="<?php echo ($setting[pointtomoney][max]); ?>"   class="txt1"/></li></ul>

	   </fieldset>
	   <fieldset><legend>现钱兑换积分配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="moneytopoint_status" name="setting[moneytopoint][status]" value="<?php echo ($setting[moneytopoint][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">现金：</li><li class="li2"><input type="text" name="setting[moneytopoint][money]" value="<?php echo ($setting[moneytopoint][money]); ?>"   class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">得积分：</li><li class="li2"><input type="text" name="setting[moneytopoint][point]" value="<?php echo ($setting[moneytopoint][point]); ?>"   class="txt1"/></li></ul>
		<ul class="ul_info"><li class="li1">限制最小现金：</li><li class="li2"><input type="text" name="setting[moneytopoint][min]" value="<?php echo ($setting[moneytopoint][min]); ?>"  class="txt1" /></li></ul>
		<ul class="ul_info"><li class="li1">限制最大现金：</li><li class="li2"><input type="text" name="setting[moneytopoint][max]" value="<?php echo ($setting[moneytopoint][max]); ?>"   class="txt1"/></li></ul>
...
<script>
onoff("pointtomoney_status",100);
onoff("moneytopoint_status",100);
</script>
<script>
