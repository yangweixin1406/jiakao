...
<form id="form1" name="form1" method="post" action="<?php echo U('content/info');?>">
<div class="info1">
       <div class="tab"><ol class="tab_ol"><li class="cur">基本信息</li><li>其它信息</li><li>全部展开</li></ol></div>
	   <div class="tab_page">
	   <ul class="ul_info"><li class="li1">文章分类：</li><li class="li2"><input type="hidden"   name="classno" id="classno"   class="txt1" value="<?php echo ($info["classno"]); ?>"/></li></ul>
       <ul class="ul_info"><li class="li1">文章标题：</li><li class="li2"><input type="text"   name="title" id="title"   class="txt1" value="<?php echo ($info["title"]); ?>"/></li></ul>
	   <ul class="ul_info"><li class="li1">标记：</li><li class="li2">
	   <script>CreateRadio("lable","<?php echo ($info["lable"]); ?>","<?php echo $GLOBALS['g_content']['lable']?>")</script></li></ul>
...
<script>
ClassOption().init({url:"<?php echo U('class/classoption');?>","id":"classno","fatherno":"<?php echo $GLOBALS['g_content']['classno']?>","classno":"<?php echo $info['classno']?>"});
