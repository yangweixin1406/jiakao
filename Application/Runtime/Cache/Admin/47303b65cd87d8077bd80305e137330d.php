...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		<div class="left"><div class="tt"><?php echo ($mytitle); ?>&nbsp;(<?php echo ($item["num"]); ?>/<?php echo ($item["rowcountz"]); ?>)</div><div class="bb"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/ExamClass/info/">添加分类</a></div><span class="btchazhao">查找</span></div>
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/ExamClass/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
				   <span class="t">分类名称<em>：</em></span><span class="f"><input type="text" name="title" id="title" value="<?php echo $_GET[title]?>" class="txt1s"/></span>
				</div>
				<div class="row">
				   <span class="t">分类ID<em>：</em></span><span class="f"><input type="text" name="id" id="id" value="<?php echo $_GET[id]?>"  class="txt1s"/></span>
				</div>
				<div class="row">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				<thead>
					<tr>
						...
						<th class='td1'>分类名称</th>
						<th class='td2'>分类id</th>
						<th class='td3'>分类编号</th>
                        <th class='td4'>排序</th>
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="tdop" style="width:auto"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/ExamClass/index/fatherno/<?php echo ($value["classno"]); ?>">查看子级</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/ExamClass/info/id/<?php echo ($value["id"]); ?>">编辑</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/ExamClass/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
