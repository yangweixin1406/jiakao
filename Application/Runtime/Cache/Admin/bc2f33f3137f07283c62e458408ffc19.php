...
<div class="info1">
	   ...
	   <div class="tab_page">
	   <ul class="ul_info"><li class="li1">用户名：</li><li class="li2"><input type="text"   name="username" id="username"   class="txt1" value="<?php echo ($info["username"]); ?>"/></li></ul>
	   ...
	   <ul class="ul_info"><li class="li1">邮箱：</li><li class="li2"><input type="text"   name="email" id="email"   class="txt1" value="<?php echo ($info["email"]); ?>"/></li></ul>
	   <ul class="ul_info ul_dianming" style="display:none;"><li class="li1">店名：</li><li class="li2"><input type="text"   name="shopname" id="shopname"   class="txt1" value="<?php echo ($info["shopname"]); ?>"/></li></ul>
	   <ul class="ul_info">
	   <li class="li1">级别：</li>
	   <li class="li2">
	   ...
	   <ul class="ul_info"><li class="li1">图片：</li><li class="li2"><input type="hidden" name="photo" id="photo"  value="<?php echo ($info["photo"]); ?>"/><iframe src="/phpsite/hc/kaoti/kaoti20170406/Public/upload_20150420/upload/php/img_iframe.php?panel_id=my_show&input_only_id=photo&input_more_id=ImageList&maxnum=10" scrolling="no" frameborder="0" height="80" width="80" style="margin:0px;"></iframe></li></ul>
