...
<form id="form1" name="form1" method="post" action="<?php echo U('sms');?>" onsubmit="return check();">
<div class="info1">


	   <div class="tab_page">
	   <fieldset><legend><?php echo ($webtitle); ?></legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="sms_status" name="setting[sms][status]" value="<?php echo ($setting[sms][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">发送类型：</li><li class="li2"><input type="text" name="setting[sms][type]" value="<?php echo ($setting[sms][type]); ?>"  class="txt1"  />get或post</li></ul>
		<ul class="ul_info"><li class="li1">短信接口：</li><li class="li2"><input type="text" name="setting[sms][url]" value="<?php echo ($setting[sms][url]); ?>"  class="txt1"  /></li></ul>
		<ul class="ul_info"><li class="li1">发送参数：</li><li class="li2"><input type="text" name="setting[sms][urlcs]" value="<?php echo ($setting[sms][urlcs]); ?>"  class="txt1" /><div>例子：uid=41511&pwd=125633&phone={phone}&content={content}</div></li></ul>
		<ul class="ul_info"><li class="li1">发送编码：</li><li class="li2"><input type="text" name="setting[sms][charset]" value="<?php echo ($setting[sms][charset]); ?>"  class="txt1" /><div>utf-8或gb2312</div></li></ul>
		<ul class="ul_info"><li class="li1">找回密码内容：</li><li class="li2"><textarea type="text" name="setting[sms][content1]" class="txt1" ><?php echo ($setting[sms][content1]); ?></textarea><div>例子：你的新密码：{pwd}</div></li></ul>
		<ul class="ul_info"><li class="li1">注册验证码内容：</li><li class="li2"><textarea type="text" name="setting[sms][content2]" class="txt1" ><?php echo ($setting[sms][content2]); ?></textarea><div>例子：你的注册验证码是：{code}</div></li></ul>
				
		<div>有不懂之处请联系QQ632175205</div>
	   </fieldset>
  ...
  <div class="info_bts">
    <div class="con">
	 ...
	 <input type="button" onclick="javascript:window.location='<?php echo ($laiyuan); ?>';"value="返回" class="bt" /><input type="submit" name="btsend" class="btsend" value="更新" /><input id="act" type="hidden" name="act" value="update"/> <input type="reset" value="重置" onclick="clearinput()" />
