...
<div class="mytitle">
  <div class="con">
    <div class="left"><div class="t"><?php echo ($webtitle); ?></div><div class="b"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Examclass/lists/">返回列表</a></div></div><div class="right"></div>
  </div>
</div>
<!--标题结束-->
<!--主体开始-->
...
<div class="info1">
	   ...
	   <div class="tab_page">
	   <?php if($info["fatherno"]=="" || $info["fatherno"]==$fatherno){ ?>
       <ul class="ul_info"><li class="li1">考题表：</li><li class="li2"><input type="text"   name="objtable" id="objtable"   class="txt1" value="<?php echo ($info["objtable"]); ?>"/></li></ul>
	    <?php } ?>
	   <ul class="ul_info"><li class="li1">分类标题：</li><li class="li2"><input type="text"   name="title" id="title"   class="txt1" value="<?php echo ($info["title"]); ?>"/></li></ul>
	   <ul class="ul_info"><li class="li1">所在父类：</li><li class="li2">
				 <input type="hidden" name="fatherno" id="fatherno" value="<?php echo ($info["fatherno"]); ?>"/>
	   </li></ul>

	   <ul class="ul_info"><li class="li1">图片：</li><li class="li2">
	   <input type="hidden" name="photo" id="photo"  value="<?php echo ($info["photo"]); ?>"/><iframe src="/phpsite/hc/kaoti/kaoti20170406/Public/upload_20150420/upload/php/img_iframe.php?panel_id=my_show&input_only_id=photo&input_more_id=ImageList&maxnum=10" scrolling="no" frameborder="0" height="80" width="80" style="margin:0px;"></iframe>
	  </li></ul>
	   ...
	   <div class="tab_page" style="display:none;">
	        <ul class="ul_info"><li class="li1">语言：</li><li class="li2">
						<select name="lang" id="lang" title="语言">
						    <?php if(is_array($langlist)): foreach($langlist as $key=>$row): ?><option value="<?php echo ($row["value"]); ?>"><?php echo ($row["title"]); ?></option><?php endforeach; endif; ?>
						</select>
			</li>
			</ul>
...
<script>
ClassOption().init({url:"<?php echo U('class/classoption');?>","id":"fatherno","fatherno":"<?php echo ($fatherno); ?>","classno":"<?php echo ($info["fatherno"]); ?>"});

</script>

<script>

$("#lang").val('<?php echo ($info["lang"]); ?>');
