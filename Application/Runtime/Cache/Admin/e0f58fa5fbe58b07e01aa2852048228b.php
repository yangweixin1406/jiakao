...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		<div class="left"><div class="tt"><?php echo ($mytitle); ?>&nbsp;(<?php echo ($item["num"]); ?>/<?php echo ($item["rowcountz"]); ?>)</div><div class="bb"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Exam1/info/table/<?php echo ($table); ?>">发布考题</a></div><span class="btchazhao">查找</span></div>
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Exam1/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
							...
							<td class="tdop"><a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Exam1/info/id/<?php echo ($value["id"]); ?>">编辑</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Exam1/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
