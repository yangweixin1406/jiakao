...
<div class="mytitle">
  <div class="con">
    <div class="left"><div class="t"><?php echo ($webtitle); ?></div><div class="b"><a href="<?php echo ($laiyuan); ?>">返回</a></div></div><div class="right"></div>
  </div>
</div>
<!--标题结束-->
<!--主体开始-->
<div class="mycontent paddingtop80" >
<form id="form1" name="form1" method="post" action="<?php echo U('pay');?>" onsubmit="return check();">
<div class="info1">


	   <div class="tab_page">
	   <fieldset><legend>支付宝配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="alipay_status" name="setting[alipay][status]" value="<?php echo ($setting[alipay][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">支付宝帐号：</li><li class="li2"><input type="text" name="setting[alipay][email]" value="<?php echo ($setting[alipay][email]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">支付宝PID：</li><li class="li2"><input type="text" name="setting[alipay][pid]" value="<?php echo ($setting[alipay][pid]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">支付宝KEY：</li><li class="li2"><input type="text" name="setting[alipay][key]" value="<?php echo ($setting[alipay][key]); ?>"  /></li></ul>
	   </fieldset>
	   <fieldset><legend>易宝配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="yeepay_status" name="setting[yeepay][status]" value="<?php echo ($setting[yeepay][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">易宝帐号：</li><li class="li2"><input type="text" name="setting[yeepay][email]" value="<?php echo ($setting[yeepay][email]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">易宝PID：</li><li class="li2"><input type="text" name="setting[yeepay][pid]" value="<?php echo ($setting[yeepay][pid]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">易宝KEY：</li><li class="li2"><input type="text" name="setting[yeepay][key]" value="<?php echo ($setting[yeepay][key]); ?>"  /></li></ul>
	   </fieldset>
	   <fieldset><legend>微信支付配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="wxpay_status" name="setting[wxpay][status]" value="<?php echo ($setting[wxpay][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">微信支付帐号：</li><li class="li2"><input type="text" name="setting[wxpay][email]" value="<?php echo ($setting[wxpay][email]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">微信支付appid：</li><li class="li2"><input type="text" name="setting[wxpay][appid]" value="<?php echo ($setting[wxpay][appid]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">微信支付appsecret：</li><li class="li2"><input type="text" name="setting[wxpay][appsecret]" value="<?php echo ($setting[wxpay][appsecret]); ?>"  /></li></ul>
	   </fieldset>
	   <fieldset><legend>云支付配置</legend>
	    <ul class="ul_info"><li class="li1">配置开关：</li><li class="li2"><input type="hidden" id="yunpay_status" name="setting[yunpay][status]" value="<?php echo ($setting[yunpay][status]); ?>"   txt1="开"  txt2="关"/></li></ul>
		<ul class="ul_info"><li class="li1">云支付帐号：</li><li class="li2"><input type="text" name="setting[yunpay][email]" value="<?php echo ($setting[yunpay][email]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">云支付PID：</li><li class="li2"><input type="text" name="setting[yunpay][pid]" value="<?php echo ($setting[yunpay][pid]); ?>"  /></li></ul>
		<ul class="ul_info"><li class="li1">云支付KEY：</li><li class="li2"><input type="text" name="setting[yunpay][key]" value="<?php echo ($setting[yunpay][key]); ?>"  /></li></ul>
	   </fieldset>
        <div class="clear"></div>
         </div>
  ...
  <div class="info_bts">
    <div class="con">
	 ...
	 <input type="button" onclick="javascript:window.location='<?php echo ($laiyuan); ?>';"value="返回" class="bt" /><input type="submit" name="btsend" class="btsend" value="更新" /><input id="id" type="hidden" name="id" value="<?php echo ($info["id"]); ?>"/><input id="act" type="hidden" name="act" value="update"/> <input type="reset" value="重置" onclick="clearinput()" />
...
onoff("alipay_status",100);
onoff("yeepay_status",100);
onoff("wxpay_status",100);
onoff("yunpay_status",100);
</script>
<script>
