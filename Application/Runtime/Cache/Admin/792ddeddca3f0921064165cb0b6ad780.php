...
<div class="mytitle">
  <div class="con">
    <div class="left"><div class="t"><?php echo ($webtitle); ?></div><div class="b"><a href="<?php echo ($laiyuan); ?>">返回列表</a></div></div><div class="right"><div class="r"><?php echo ($info["addtime"]); ?></div></div>
  </div>
</div>
<!--标题结束-->
<!--主体开始-->
...
<div class="info1">
       <div class="tab"><ol class="tab_ol"><li class="cur">基本信息</li><li>明细</li><li>全部展开</li></ol></div>
	   <div class="tab_page">
	   <ul class="ul_info"><li class="li1">ID：</li><li class="li2"><?php echo ($info["id"]); ?></li></ul>
	   <ul class="ul_info"><li class="li1">订单编号：</li><li class="li2"><?php echo ($info["orderno"]); ?></li></ul>
       <ul class="ul_info"><li class="li1">订单金额：</li><li class="li2"><?php echo ($info["price"]); ?>块</li></ul>
	   <ul class="ul_info"><li class="li1">运费：</li><li class="li2"><?php echo ($info["fare"]); ?>块</li></ul>
	   <ul class="ul_info"><li class="li1">总金额：</li><li class="li2"><?php echo ($info["total"]); ?>块</li></ul>
	   <ul class="ul_info"><li class="li1">提交日期：</li><li class="li2"><?php echo ($info["addtime"]); ?></li></ul>
	   <ul class="ul_info"><li class="li1">结束日期：</li><li class="li2"><?php echo ($info["endtime"]); ?></li></ul>
	   <ul class="ul_info"><li class="li1">支付状态：</li><li class="li2"><?php echo ($info["status_caption"]); ?></li></ul>
	   <ul class="ul_info"><li class="li1">支付方式：</li><li class="li2"><?php echo ($info["payname"]); ?></li></ul>
	   <ul class="ul_info"><li class="li1">第三方编号：</li><li class="li2"><?php echo ($info["tradeno"]); ?></li></ul>
	   <ul class="ul_info"><li class="li1">发货状态：</li><li class="li2">
						<select name="lable" id="lable" title="状态">
						<option value="">请选择</option>
						<?php if(is_array($lablelist)): foreach($lablelist as $key=>$row): ?><option value="<?php echo ($row["value"]); ?>"><?php echo ($row["title"]); ?></option><?php endforeach; endif; ?>
						</select>
	   </li></ul>
       <ul class="ul_info"><li class="li1">卖家备注：</li><li class="li2">
	    <textarea type="text"  name="dianjiabeizhu" id="dianjiabeizhu"   class="txt1" ><?php echo ($info["dianjiabeizhu"]); ?></textarea></li></ul>
	   <ul class="ul_info"><li class="li1">买家备注：</li><li class="li2">
	    <textarea type="text"  name="userbeizhu" id="userbeizhu"   class="txt1" ><?php echo ($info["userbeizhu"]); ?></textarea>
	   </li>
      </ul>
        <div class="clear"></div>
	   ...
	   <div class="tab_page" style="display:none;">
			<table cellspacing="1" cellpadding="10" class="table_detail">
				<thead>
					<tr>
						<th>序号</th>
						<th>名称</th>
				...
				<tbody style="text-align:center;">
					<?php if(is_array($detail)): $i = 0; $__LIST__ = $detail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($key+1); ?></td>
                            <td><?php echo ($value["title"]); ?></td>
                            <td><?php echo ($value["price"]); ?></td>
							<td><?php echo ($value["num"]); ?></td>
							<td><?php echo ($value["pricez"]); ?></td>
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>
			<div style="background-color:#f5f5f5; padding:5px;">合计：<?php echo ($item["total"]); ?>块 数量：<?php echo ($item["num"]); ?>件 </div>
	   </div>
    </div>
