...
<div class="mytitle" style="z-index:100;">
	<div class="con">
		...
		<div class="right">
			<form id="form1" name="form1" method="get" action="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Link/lists/" ><div class="l"></div>
			<div  class="r">
				<div class="row">
               ...
               <table class="tablelist tableloglat" cellspacing="0">
				...
				<tbody style="text-align:center;">
					<?php if(is_array($list)): foreach($list as $key=>$value): ?><tr>
                            ...
                            <td class="td3"><?php if($value[photo_small] == '' ): else: ?><img src="/phpsite/hc/kaoti/kaoti20170406/<?php echo ($value["photo_small"]); ?>" style="height:50px;"/><?php endif; ?></td>
							...
							<td class="tdop"><a href="<?php echo U('link/info',array('id'=>$value[id]));?>">编辑</a>|<a href="/phpsite/hc/kaoti/kaoti20170406/index.php/Admin/Link/delete/id/<?php echo ($value["id"]); ?>">删除</a></td>
