...
function Upload(){
	var Upload_={
		Init:function(opt){
            ...
            t.fengmian_html="<table cellpadding='0' cellspacing='0' border='0' style='height:"+window.clientHeight+"px;width:100%;'><tr style='height:100%;'><td valign='middle' style='height:100%;'><img src='"+g_fengmian_src+"' style='width:"+window.clientWidth+"px; height:"+window.clientHeight+";'/></td></tr></table>";
