...
$notify_url= dirname($cururl)."/notify.php";

require_once "lib/WxPay.Api1.php";
...
<body>
    <br/>
    <font color="#9ACD32"><b>该笔订单支付金额为<span style="color:#f00;font-size:50px"><?php echo $total;?>分</span>钱</b></font><br/><br/>
	<div align="center">
